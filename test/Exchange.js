...
describe('Exchange', () => {
  ...
  describe("Depositing Tokens", () =>   {
   ...
   describe('Failure', () =>{
    it('fails when no tokens are approved', async () => {
      await expect(exchange.connect(user1).depositToken(token1.address)).to.be.reverted; // dont approve tokens before depositing
    });
   });
  });
  describe("Withdrawing Tokens", () => {
   ...
   describe('Failure', () =>{
    it('fails when no tokens are approved', async () => {
      await expect(exchange.connect(user1).withdrawToken(token1.address)).to.be.reverted; // dont approve tokens before depositing
    });
   });
  });
